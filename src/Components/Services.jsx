  ...
  return (
    ...
    px-6 py-10 text-center space-y-6 items-center justify-center">
      ...
      >
        <h1
          id="head"
          className="text-center font-bold text-5xl sm:text-7xl bg-clip-text text-transparent mb-10 bg-gradient-to-r from-violet-400 via-pink-500 to-yellow-50"
        >
          Services
        </h1>
        ...
        <p
          id="para"
          className="text-gray-500 opacity-0 translate-y-10 transition-all duration-700"
        >
