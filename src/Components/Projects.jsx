...
function Projects() {
  ...
  return (
    <div className='flex flex-col justify-center items-center px-4 pt-16 bg-white'>
      ...
      {/* Header */}
     <div className='bg-gray-100 border border-gray-300 rounded-2xl shadow-lg w-[90%]
        ...
        <p
          ...
          opacity-0 translate-x-10 leading-relaxed text-center px-2 sm:px-8'
        >
      ...
      {/* Buttons */}
      <ul className='flex flex-wrap items-start justify-center py-4 gap-4 mt-10 '>
        {
            ...
            projectImages[selectedProject].map((img, index) => {
              ...
              return (
                <img
                  ...
                  className='w-[90%] h-48 object-cover shadow-md cursor-pointer'
